...
from ui.messages import DomainTexts

PARTNER_TYPE_FACTORY = DomainTexts.PARTNER_TYPE_FACTORY
PARTNER_TYPE_FABRIC = DomainTexts.PARTNER_TYPE_FABRIC
PARTNER_TYPE_TRIM = DomainTexts.PARTNER_TYPE_TRIM
PARTNER_TYPE_DYEING = DomainTexts.PARTNER_TYPE_DYEING
PARTNER_TYPE_FINISH = DomainTexts.PARTNER_TYPE_FINISH
PARTNER_TYPE_OTHER = DomainTexts.PARTNER_TYPE_OTHER
