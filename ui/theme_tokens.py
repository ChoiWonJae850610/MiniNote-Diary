...
class ThemeTokens:
    ...
    dashboard_metric_card_min_height: int = 104
    dashboard_metric_padding_x: int = 18
    dashboard_metric_padding_y: int = 16
    dashboard_metric_spacing: int = 10
    dashboard_recent_padding: int = 18
    dashboard_recent_spacing: int = 12
    ...
    dashboard_recent_panel_min_height: int = 356
    dashboard_metric_value_font_px: int = 19
    menu_hero_padding_x: int = 26
    menu_hero_padding_y: int = 20
    menu_hero_spacing: int = 10
    menu_section_padding: int = 20
    menu_section_spacing: int = 14
    menu_action_card_min_height: int = 98
    menu_action_card_padding_x: int = 18
    menu_action_card_padding_y: int = 16
    menu_recent_row_count: int = 4
    menu_recent_item_min_height: int = 68
    menu_recent_item_padding_x: int = 14
    menu_recent_item_padding_y: int = 10
    menu_recent_item_spacing: int = 4
    menu_recent_primary_height: int = 20
    menu_recent_secondary_height: int = 18
