...
class ThemeTokens:
    ...
    work_order_toolbar_panel_min_height: int = 28
    work_order_column_spacing: int = 10
    work_order_toolbar_inner_padding: int = 6
    work_order_postit_top_offset: int = 0
    work_order_toolbar_to_image_overlap: int = 12
    work_order_bottom_safe_reserve: int = 28
    work_order_image_preview_min_height: int = 590
