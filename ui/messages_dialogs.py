...
class Warnings:
    ...
    ORDER_SELECT_TEMPLATE_FIRST = "발주 의뢰할 작업지시서를 먼저 선택하세요."
    INBOUND_SELECT_ORDER_FIRST = "입고&검수할 발주 의뢰를 먼저 선택하세요."
...
class InfoMessages:
    ...
    INBOUND_PENDING = "입고&검수 화면 골격만 먼저 연결했습니다. 다음 단계에서 실제 저장과 재고 반영 로직을 붙입니다."
