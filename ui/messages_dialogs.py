...
class Warnings:
    ...
    INBOUND_QTY_INVALID = "입고 수량은 1 이상, 잔여 수량 이하로 입력하세요."
    PRODUCT_SELECT_FIRST = "상품을 먼저 선택하세요."
    PRODUCT_PENDING_SELECT_FIRST = "검수할 미검수 입고 건을 먼저 선택하세요."
    PRODUCT_SALE_QTY_INVALID = "판매 수량은 1 이상, 현재 재고 이하로 입력하세요."
...
class InfoMessages:
    ...
    INBOUND_APPLIED = "입고&검수 저장 완료\n\n정상 반영: {good_qty}\n불량: {defect_qty}\n남은 수량: {remaining_qty}"
    INBOUND_APPLIED_PENDING = "입고 저장 완료\n\n검수 예외처리로 미검수 물량에 넣었습니다.\n남은 수량: {remaining_qty}"
    PRODUCT_SAVED = "상품 정보가 저장되었습니다."
    PRODUCT_INSPECTION_APPLIED = "미검수 검수를 반영했습니다.\n\n정상 반영: {good_qty}\n불량: {defect_qty}"
    PRODUCT_SALE_SAVED = "판매 등록이 저장되었습니다.\n\n판매 수량: {sale_qty}\n남은 재고: {stock_qty}"
