...
class MenuPageTexts:
    TITLE = "오늘의 작업 다이어리"
    SUBTITLE = "오늘 확인할 업무와 자주 쓰는 화면을 먼저 배치한 메인 화면입니다."
    DATE_PREFIX = "기록 기준"
    FLOW_TITLE = "업무 메뉴"
    FLOW_SUBTITLE = "자주 쓰는 화면을 카드형으로 정리했습니다."
    STATUS_TITLE = "오늘 현황"
    STATUS_SUBTITLE = "현재 저장된 데이터를 기준으로 바로 확인합니다."
    UTILITIES_TITLE = "빠른 관리"
    UTILITIES_SUBTITLE = "설정이나 관리성 기능은 작은 카드로 분리합니다."
    ...
    TEMPLATE_TITLE = "작업지시서"
    TEMPLATE_SUBTITLE = "기준 문서 관리"
    ORDER_TITLE = "발주 의뢰"
    ORDER_SUBTITLE = "수량 · 일정 입력"
    RECEIPT_TITLE = "자재 검토"
    RECEIPT_SUBTITLE = "발주 화면에 통합"
    COMPLETE_TITLE = "입고 & 검수"
    COMPLETE_SUBTITLE = "입고 · 불량 반영"
    SALE_TITLE = "상품 관리"
    SALE_SUBTITLE = "가격 · 판매 관리"
    INVENTORY_TITLE = "재고 / 통계"
    INVENTORY_SUBTITLE = "흐름 확인"
    SETTINGS_TITLE = "환경 설정"
    SETTINGS_SUBTITLE = "화면 · 데이터 옵션"
